...
public class DialogControllerBackup : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (StartConversation)
        {
            ...
            if (animator1st.GetCurrentAnimatorStateInfo(0).IsName("Idle") && animator2nd.GetCurrentAnimatorStateInfo(0).IsName("Idle") && counter >= actualDialog.Count)
            {
